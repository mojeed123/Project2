    ...
    return (
        <div className="kl">
            <Container>
              ...
              <Col>
                  <Card>
                <Card.Img className='casual2' variant="top" src="https://images.footlocker.com/is/image/EBFL2/4206457_a1?wid=520&hei=520&fmt=png-alpha" />
                <Card.Body>
                  <Card.Title>New Balance 547</Card.Title>
                  <Card.Text>
                  $200
                  <p>Rating: 5 out of 5</p>
                  </Card.Text>
